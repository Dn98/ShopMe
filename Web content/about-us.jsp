        ...
        <section class="clean-block about-us">
            <div class="container">
                <div class="block-heading">
                    ...
                    <p>Shopme is leading destination for online shopping in sri lanka.Offering some of the best price and complete hassle-free experience with options of paying through cash on delivery,debit card,credit card and internet banking processed through the secure and trusted gateways.</p>
                </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card clean-card text-center"><img class="card-img-top w-100 d-block" src="assets/img/avatars/avatar1.jpg">
                            <div class="card-body info">
                                <h4 class="card-title">Malinda Wijeysoriya</h4>
                                <p class="card-text">IT18008692</p>
