                ...
                <form action="paymentServlet" method="post" >
                    <div class="products">
                        ...
                        <div class="item"><span class="price">$200</span>
                            ...
                            <p class="item-description">Shirt</p>
                        </div>
                        <div class="item"><span class="price">$120</span>
                            <p class="item-name">Product 2</p>
                            <p class="item-description">Trouser</p>
                        </div>
                    ...
                    <div class="card-details">
                        ...
                        <div class="form-row">
                            <div class="col-sm-7">
                                <div class="form-group"><label for="card-holder">Card Holder</label><input class="form-control" type="text" placeholder="Card Holder" name = "cardholder"></div>
                            </div>
                            <div class="col-sm-5">
                                <div class="form-group"><label>Expiration date</label>
                                    <div class="input-group expiration-date"><input class="form-control" type="text" placeholder="MM" name="mm"><input class="form-control" type="text" placeholder="YY" name="yy"></div>
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="form-group"><label for="card-number">Card Number</label><input class="form-control" type="text" placeholder="Card Number" id="card-number" name="cardNo"></div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group"><label for="cvc">CVC</label><input class="form-control" type="text" placeholder="CVC" id="cvc" name = "cvc"></div>
                            </div>
                            <div class="col-sm-12">
